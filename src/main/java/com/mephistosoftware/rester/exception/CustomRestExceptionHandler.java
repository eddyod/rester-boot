...
import com.mephistosoftware.rester.model.ApiError;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleRedundantEmail(final ConstraintViolationException ex,
			final WebRequest request) {
		logger.info(ex.getClass().getName());
		//
		final String error = ex.getMessage() + " That email is already being used. ";
