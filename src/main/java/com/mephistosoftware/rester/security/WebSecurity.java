...
import static com.mephistosoftware.rester.security.SecurityConstants.SOCIAL_LOGIN;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.OPTIONS, SOCIAL_LOGIN).permitAll()
		.antMatchers(HttpMethod.POST, SOCIAL_LOGIN).permitAll()
    ...
    */
	...
	public void configure(AuthenticationManagerBuilder auth) throws Exception {
	  ...
	  CorsConfigurationSource corsConfigurationSource() { 
		...
		// configuration.setAllowedOrigins(Arrays.asList("https://www.mephistosoftware.com", "http://localhost:4200", "http://localhost:8100", "http://10.195.4.147:4200", "http://localhost" ));
